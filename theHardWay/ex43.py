...
class Scene(object):
    ...
    def enter(self):
        print "This is an abstract scene. Subclass it and implement enter()"
        exit(1)
...
class CentralCorridor(Scene):
    def enter(self):
        ...
        if action == "shoot!":
            ...
            Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fbgf nebhaq gur ubhfr.
            The Gothon stops, tries not to laugh, then bursts out laughing and can't move.
            While he's laughing you run up and shoot him square in the head
            putting him down, then jump through the Weapon Armory door.
            """
            print textwrap.fill(textwrap.dedent(text), 65)
...
class LaserWeaponArmory(Scene):
    def enter(self):
        ...
        """
        wrapper = textwrap.dedent(text).strip()
        print textwrap.fill(wrapper, width=70)
...
class TheBridge(Scene):
    def enter(self):
        ...
        the last. They haven't pulled their weapons out yet, as they see
        ...
        if action == "throw the bomb":
            ...
            Gothon shoots you right in the back and kill you.
            As you die you see another Gothon frantically try to
            disarm the bomb. You die knowing they will probably blow
            up when it goes off.
            """
            return 'death'
...
class EscapePod(Scene):
    def enter(self):
        text =  """You rush through the ship desperately trying to make it to
        ...
        wrapper = textwrap.dedent(text).strip()
        print textwrap.fill(wrapper, width=50)
        ...
        if int(guess) != good_pod:
            ...
            print "implodes as the hull ruptures, crushing your body into jam jelly."
            return 'death'
        else:
            print "You jump into pod %s and hit the eject button." % guess
            ...
            print "your ship implode then explode like a bright star, taking out "
            print "the Gothon ship at the same time. You won!"
